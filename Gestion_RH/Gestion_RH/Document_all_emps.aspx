<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Emp.Master" AutoEventWireup="true" CodeBehind="Document_all_emps.aspx.cs" Inherits="Gestion_RH.WebForm5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div>
        <nav class="navbar justify-content-between" style="margin-top: -30px; ; margin-bottom: 10px; box-shadow: none; padding: 0 0 0 10px; ">
          ...
          <p style="padding-top: 10px;"><span class="fa fa-home mr-1"></span><span style="color: black; font-weight: 300">Dashboard</span> > Document Employées</p>
        </nav>

        <h3 runat="server" style="text-align: center; font-weight: bold; color: gray">Voici Document De<br /> Tout Employés .</h3>

       <div class="row">
        <div class="col-md-12">
           <div style="padding: 10px; width: 100px; float: right">
              <asp:Button runat="server" ID="btnPront" class="btn btn-primary btn-user btn-block" Font-Size="15px" Text="Print" OnClick="btnPront_Click"/>
           </div>
        <div class="table-responsive" style="margin: auto; height:500px;overflow:auto">
        <asp:Panel ID="panelPDF" runat="server">
            <asp:GridView ID="GridView4" runat="server" style="overflow-x:auto; max-width: 100%; text-align: center;" 
                HeaderStyle-CssClass="HeaderGridStyle" CssClass="table table-bordered table-condensed" CellPadding="4" 
                ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" DataKeyNames="matricule" DataSourceID="SqlDataSource5">
            ...
            <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:Gestion_RHConnectionString6 %>" SelectCommand="SELECT * FROM [employé]"></asp:SqlDataSource>
        </asp:Panel>
            </div>
            </div>
         </div>
